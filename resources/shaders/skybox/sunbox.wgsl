...
@group(1)
@binding(2)
var<uniform> sun_buffer: SunData;
...
fn vs_sky(@builtin(vertex_index) vertex_index: u32) -> SkyOutput {
    ...
    let myMat3x3 = mat3x3(sun_buffer.rotation[0].xyz, sun_buffer.rotation[1].xyz, sun_buffer.rotation[2].xyz);
    ...
    result.uv = myMat3x3 * inv_model_view * unprojected.xyz;
    result.position = pos;
    return result;
}
